...
<!-- Head -->
 ...
 <div class="content-header shadow-lg">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h2 class="border-bottom pb-2 mb-6 ">Tous nos partenaires</h2>
          </div><!-- /.col -->
         ...
         <form class="form-inline ml-3" method="get" action="{{route('searchpart')}}">
                <div class="input-group input-group-sm shadow-sm">
                    <input name="search" class="form-control form-control-navbar" type="search" placeholder="Recharche par 'pays'" aria-label="">
          ...
          <!-- //search -->
            ...
            <div class="div" style="padding:4px 4px;">
                <a href="{{route('export-partenaires')}}" class="btn btn-success"
