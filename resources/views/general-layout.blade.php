...
<div class="modal fade" id="user-add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <button  href="" class="btn btn-nav" data-bs-toggle="modal" data-bs-target="#user-add"><i class="fas fa-user-plus"></i> admin
        </button>
     </li>
     <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('users-list')}}" class="btn btn-nav"><i class="far fa-eye"></i> Liste membres</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('guide')}}" class="nav-link"><i class="fab fa-leanpub"></i> Guide</a>
      </li>
    </ul>
    <!-- Right navbar links -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>
                ...
                <span class="badge badge-warning right">4 liens</span>
              </p>
            </a>
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('conventions')}}" class="nav-link">
                <i class="fas fa-handshake"></i>
                  <p>Conventions</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('missions')}}" class="nav-link">
          ...
          <li class="nav-item rounded" style="background:white;">
            <a href="{{route('projets.membres')}}" class="nav-link">
              <p style="color:green; font-size:18px; font-style: bold;">
                Appels à projets
                <span class="right badge badge-info">Membres</span>
              </p>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            <a href="{{route('chartUser')}}" class="nav-link">
              <i class="fas fa-chart-line"></i>
              <p>Utilisateurs
                      <span class="right badge badge-danger">Suivre</span>
              </p>
            </a>
            <!--  -->
          </li>
          <li class="nav-item has-treeview">
            <a href="{{route('chartRealisation')}}" class="nav-link">
              <i class="fas fa-chart-line"></i>
              <p>Realisations
